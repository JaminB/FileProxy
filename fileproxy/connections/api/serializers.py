...
class ConnectionListSerializer(serializers.ModelSerializer):
    ...
    def get_bucket(self, obj: Connection) -> str | None:
        payload = obj.get_payload()
        settings = payload.get("settings", {})
        return settings.get("bucket")

    def get_account_name(self, obj: Connection) -> str | None:
        payload = obj.get_payload()
        settings = payload.get("settings", {})
        return settings.get("account_name")

    def get_container_name(self, obj: Connection) -> str | None:
        payload = obj.get_payload()
        settings = payload.get("settings", {})
...
class ConnectionRenameSerializer(serializers.Serializer):
    name = serializers.CharField(max_length=120)
