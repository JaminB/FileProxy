...
function renderKindCards(metrics: VaultMetrics): void {
...
function renderRecent(recent: RecentItem[]): void {
...
async function load(): Promise<void> {
  try {
    const metrics = await apiJson<VaultMetrics>("/api/v1/usage/vault-metrics/");
